...
class IDFormer(nn.Module):
    """
    Perceiver resampler-like architecture for PuLID v1.1.
    Concatenates id embedding (from arcface) and query tokens as latents,
    which attend to each other and interact with multi-scale ViT features
